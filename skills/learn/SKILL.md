---
name: learn
description: Deep codebase exploration that builds persistent project memory. Like /init but stores findings in DynaMite for cross-session recall.
---

# Learn — Build Project Memory

Explore the codebase deeply and store structured findings as persistent memories. This is the DynaMite equivalent of `/init` — but instead of writing a one-time CLAUDE.md, it builds incrementally updatable project knowledge.
